  ...
  return (
    ...
    >
      <div className="bordered flex w-72 items-center justify-center">
        <div className="flex h-full w-full flex-row items-center" style={{ color: 'var(--theme-code-variable)' }}>
          ...
          <span className="bordered flex h-full items-center justify-center px-2">
            <a href="https://www.linkedin.com/in/timspizza/">
              <FaLinkedin 
                ...
                onMouseEnter={e => e.currentTarget.style.color = 'var(--theme-text-light)'}
                onMouseLeave={e => e.currentTarget.style.color = 'var(--theme-code-variable)'}
              />
            </a>
          </span>
          <span className="bordered flex h-full items-center justify-center px-2">
