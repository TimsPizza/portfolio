...
const Landing = () => {
  return (
    <div className="relative h-full w-full">
      <div
        id="bg-overlay"
        className="pointer-events-none absolute left-0 top-0 z-0 h-full w-full select-none blur-md"
      >
        <BackgroundCanvas />
      </div>
      <div className="container z-10 mx-auto px-4 py-20">
        ...
        {/* Description */}
        <div className="mt-8 flex w-full flex-col gap-4 px-20">
        ...
        <div className="ml-4 mt-8 flex flex-col items-center justify-start tracking-wide">
